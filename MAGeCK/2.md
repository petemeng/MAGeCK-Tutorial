...
src = Path('MAGeCK/full/counts/article1_basic_full_raw/mageck_count.count.txt')
dst = Path('MAGeCK/full/counts/article2_full_raw/mageck_count.mle_compatible.txt')
...
```
📊 输出：
70K   MAGeCK/full/reports/figures/article2_pub_beta_distribution_full.png
