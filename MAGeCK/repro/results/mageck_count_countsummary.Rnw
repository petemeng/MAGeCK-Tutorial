...
library(xtable)
filelist=c("data/basic/CTRL_rep1.fastq","data/basic/CTRL_rep2.fastq","data/basic/TREAT_rep1.fastq","data/basic/TREAT_rep2.fastq");
labellist=c("CTRL_rep1","CTRL_rep2","TREAT_rep1","TREAT_rep2");
reads=c(2500,2500,2500,2500);
mappedreads=c(1453,1453,1471,1471);
totalsgrnas=c(2550,2550,2550,2550);
zerocounts=c(1276,1276,1199,1199);
giniindex=c(0.5266899931488773,0.5266899931488773,0.4930917310247763,0.4930917310247763);
...
genboxplot("mageck_count.count_normalized.txt");
@
...
genhistplot("mageck_count.count_normalized.txt");
@
...
genpcaplot("mageck_count.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.9,height=4.9>>=
genclustering("mageck_count.count_normalized.txt");
@
