...
```r
rra <- ReadRRA('full/results/article1_basic_full_raw/mageck_test.gene_summary.txt')
rank_vec <- rra$Score
...
rra <- ReadRRA('full/results/article1_basic_full_raw/mageck_test.gene_summary.txt')
beta <- ReadBeta('full/results/article2_full_raw/mageck_mle.gene_summary.txt')
...
```bash
du -h \
  full/reports/figures/article3_pub_flute_rankview_full.png \
  full/reports/figures/article3_pub_flute_squareview_full.png \
  full/reports/figures/article3_pub_flute_go_full.png \
  full/reports/figures/article3_pub_depmap_overlap_full.png \
  full/results/article3_integrative/depmap_overlap_summary.tsv
```

```
📊 输出：
44K   full/reports/figures/article3_pub_depmap_overlap_full.png
64K   full/reports/figures/article3_pub_flute_rankview_full.png
144K  full/reports/figures/article3_pub_flute_go_full.png
164K  full/reports/figures/article3_pub_flute_squareview_full.png
77B   full/results/article3_integrative/depmap_overlap_summary.tsv
```
