...
> ✅ 2026-03-15 实跑修订
> - 可执行版代码：`repro/analysis/05_drug_interaction.R`
...
**247 个合成致死候选基因，156 个抵抗候选基因。** 这些数字在 olaparib 筛选中是合理的范围。
...
**核心结果：** 247 个合成致死候选基因，以 *BRCA1/2*、*PALB2*、*RAD51C/D* 等 HR 修复通路基因为首——完美验证了 PARP 抑制剂的合成致死机制。156 个抵抗候选，以 *PARP1/2*（药物靶标）和 *TP53BP1*/*SHLD1/2*（HR 恢复因子）为首。
