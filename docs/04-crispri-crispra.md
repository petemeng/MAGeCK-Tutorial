...
# CRISPR 筛选最佳实践系列（四）：CRISPRi/CRISPRa 筛选分析策略——不切 DNA 的基因扰动
...
![图 1：TSS 距离与效率](assets/figures/pub_tss_distance.png)
...
![图 3：CRISPRa LFC 分布](assets/figures/pub_crispra_dist.png)
