...
python - <<'PY'
import csv
rows = list(csv.DictReader(open('repro/results/crispri_test.gene_summary.txt'), delimiter='	'))
...
python - <<'PY'
import csv
rows = list(csv.DictReader(open('repro/results/crispra_test.gene_summary.txt'), delimiter='	'))
